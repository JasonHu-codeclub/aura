...
    inPreparing: '准备中',
    ...
    meetingTime: '预约时间',
    internalParticipants: '内部参与人员',
    promptInternalParticipants: '请选择内部参与人员',
    addInteParticipants: '添加内部参与人员',
    departmentOfBooker: '预订人所在院系',
    addExtParticipants: '添加外部参与人员',
    searchContent: '请输入搜索内容',
    externalParticipants: '外部参与人员',
  ...
  placeholder: {
    ...
    participants: '参会人员',
    sender: '发起人',
    validateTheme: '请输入课程(项目|活动)名称',
    conferenceInfor: '教室信息',
    department: '请选择部门',
    companiesNum: '数量',
    selectType: '请选择预约类型',
    nameTypes: '课程(项目|活动)名称/发起人/参会人',
    keyword: '关键字',
    startDate: '开始日期',
    endDate: '结束时间',
    selectServe: '请选择教室茶点服务',
    selectEquipment: '请选择教室设备服务',
    enterReason: '请输入拒绝原因',
    inputPassword: '请输入密码',
    startTime:'起始时间',
    endTime:'结束时间',
  ...
  tip: {
    ...
    loginSuccess: '登录成功',
    conflictHead: '该教室此时间段已有{count}场申请未审批,',
