  ...
  <div class="app-wrap user-wrap">
    ...
    <div class="user-list">
      <div class="user-list-left">
        ...
        <!-- 保存 -->
        <div class="btn-group">
          <el-button type="primary" @click="serve" :loading="saveLoading">{{
            $t("button.save")
          }}</el-button>
        </div>
      </div>
      ...
      <div class="user-image">
        <upload :img.sync="imgUrl" :onSuccess="uploadSuccess" />
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        oldPass: [{ validator: validatePass0, trigger: "blur", required: true }],
        pass: [{ validator: validatePass, trigger: "blur", required: true }],
        newkPass: [{ validator: validatePass2, trigger: "blur", required: true }]
      }
    };
  },
  mounted() {
  ...
  methods: {
    ...
    async getUserInfo() {
      ...
      this.imgUrl = this.userForm.thumb_avatar
        ? this.baseURL + this.userForm.thumb_avatar
        : this.baseImg;
    },
    /*修改密码*/
