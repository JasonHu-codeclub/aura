...
<template>
  <div>
    <meet-info ref="meetInfo" :data-type="2" @saveInfo="saveInfoLeave" @changeIsSave="IsSaveHanld"/>
    <!-- 离开页面提示 -->
    <dialog-page-close ref="dialogPage" @confirmHandling="confirmToPage" @cancelHandling="cancelHanld"/>
  </div>
